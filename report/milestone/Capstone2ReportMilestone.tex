...
\usepackage{mathtools,setspace,indentfirst,graphicx,float,url}
...
\section{Implementation of the Algorithm}
  ...
  \begin{figure}[H]
    ...
    \end{lstlisting}
    \caption{Code for the \texttt{has\_edge} function of our graph class}
  \end{figure}

  This method calls the built-in \texttt{in} function of Python lists, and has a runtime complexity of O(n).\cite{bigopy}
